...
exports.ALL_TW_CLASSES = void 0;
exports.getTwCompletions = getTwCompletions;
...
function getTwCompletions(partial) {
    if (!partial)
        return exports.ALL_TW_CLASSES;
    return exports.ALL_TW_CLASSES.filter(cls => cls.startsWith(partial));
}
